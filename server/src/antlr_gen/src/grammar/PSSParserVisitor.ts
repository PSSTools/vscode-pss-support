 ...
 */
export interface PSSParserVisitor<Result> extends ParseTreeVisitor<Result> {
	/**
	...
	/**
	 * Visit a parse tree produced by `PSSParser.annotation_values`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitAnnotation_values?: (ctx: Annotation_valuesContext) => Result;

	/**
	 * Visit a parse tree produced by `PSSParser.annotation_value`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
